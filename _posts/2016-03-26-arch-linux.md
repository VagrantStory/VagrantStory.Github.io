...
For most my computer life I have either used OS X or Linux. OS X was great but once I finally decided to try Fedora I never went back. I tried out all sorts of Linux distros (ie. Raspbian, Arch linux, Debian, Ubuntu , Kali) but none of them seemed right for me. After doing some searching around and I came to the conclusion that I had to attempt the unthinkable, Arch Linux.

# About My Computer
*Hardware*: The PC I mainly use is a desktop that I built a few years back with a Intel Core i7, Nvidia GTX 970, and 16 GB of RAM.
